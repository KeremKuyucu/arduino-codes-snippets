...
#define buton D12
#define buton1 D13 
const char *ssid = "Deneyap_ART13";    // DeneyapKart Erisim Noktasi (AP) ismi
const char *password = "12345678";  // DeneyapKart Erisim Noktasi (AP) sifresi
...
void loop() {
  int but2= digitalRead(buton);
  int but1= digitalRead(buton1);
